...
Basado en el artículo: *"Automation of Vital Signs Monitoring Through Smart Sensors and GSM Communication for Elderly Care"* (Disponible en este repositorio como `circe_paper.pdf`).
